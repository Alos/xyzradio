...
}), new objj_method(sel_getUid("setDataSource:"), function $CPOutlineView__setDataSource_(self, _cmd, aDataSource)
{ with(self)
{
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("numberOfRowsInTableView:"), function $CPOutlineView__numberOfRowsInTableView_(self, _cmd, aTableView)
{ with(self)
{
    return _numberOfVisibleItems;
}
}), new objj_method(sel_getUid("tableView:objectValueForTableColumn:row:"), function $CPOutlineView__tableView_objectValueForTableColumn_row_(self, _cmd, aTableView, aTableColumn, aRowIndex)
{ with(self)
{
