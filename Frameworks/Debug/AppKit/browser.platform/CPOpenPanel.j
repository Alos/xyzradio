...
}), new objj_method(sel_getUid("init"), function $CPOpenPanel__init(self, _cmd)
{ with(self)
{
...
}), new objj_method(sel_getUid("filenames"), function $CPOpenPanel__filenames(self, _cmd)
{ with(self)
{
    return _files;
}
}), new objj_method(sel_getUid("runModalForDirectory:file:types:"), function $CPOpenPanel__runModalForDirectory_file_types_(self, _cmd, absoluteDirectoryPath, filename, fileTypes)
{ with(self)
{
...
}), new objj_method(sel_getUid("runModalForTypes:"), function $CPOpenPanel__runModalForTypes_(self, _cmd, fileTypes)
{ with(self)
{alert("HERE");
