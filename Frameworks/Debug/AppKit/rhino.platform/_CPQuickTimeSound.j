...
}), new objj_method(sel_getUid("_CreateDOMObjectElement:"), function $_CPQuickTimeSound___CreateDOMObjectElement_(self, _cmd, aFileName)
{ with(self)
{
...
}), new objj_method(sel_getUid("_CreateDOMEmbedElement:"), function $_CPQuickTimeSound___CreateDOMEmbedElement_(self, _cmd, aFileName)
{ with(self)
{
...
}), new objj_method(sel_getUid("initWithFile:mixer:"), function $_CPQuickTimeSound__initWithFile_mixer_(self, _cmd, aFileName, mixerDiv)
{ with(self)
{
...
}), new objj_method(sel_getUid("isPlaying"), function $_CPQuickTimeSound__isPlaying(self, _cmd)
{ with(self)
{
    return _Player.GetRate() != 0;
}
}), new objj_method(sel_getUid("play"), function $_CPQuickTimeSound__play(self, _cmd)
{ with(self)
{
    _Player.Play();
}
}), new objj_method(sel_getUid("pause"), function $_CPQuickTimeSound__pause(self, _cmd)
{ with(self)
{
    _Player.Stop();
}
}), new objj_method(sel_getUid("stop"), function $_CPQuickTimeSound__stop(self, _cmd)
{ with(self)
{
    _Player.Rewind();
    _Player.Stop();
}
}), new objj_method(sel_getUid("volume"), function $_CPQuickTimeSound__volume(self, _cmd)
{ with(self)
{
    return _Player.GetVolume() / 256.0;
}
}), new objj_method(sel_getUid("setVolume:"), function $_CPQuickTimeSound__setVolume_(self, _cmd, volume)
{ with(self)
{
    if (volume > 1)
        volume = 1;
...
}), new objj_method(sel_getUid("duration"), function $_CPQuickTimeSound__duration(self, _cmd)
{ with(self)
{
    return _Player.GetDuration() / _Player.GetTimeScale();
}
}), new objj_method(sel_getUid("loops"), function $_CPQuickTimeSound__loops(self, _cmd)
{ with(self)
{
    return _Player.GetIsLooping() != 0;
}
}), new objj_method(sel_getUid("setLoops:"), function $_CPQuickTimeSound__setLoops_(self, _cmd, loops)
{ with(self)
{
    _Player.SetIsLooping(loops?1:0);
}
}), new objj_method(sel_getUid("currentTime"), function $_CPQuickTimeSound__currentTime(self, _cmd)
{ with(self)
{
    return _Player.GetTime() / _Player.GetTimeScale();
}
}), new objj_method(sel_getUid("setCurrentTime:"), function $_CPQuickTimeSound__setCurrentTime_(self, _cmd, time)
{ with(self)
{
    if(time < 0)
        time = 0;
