c;9230;var _CPHUDWindowViewBackgroundColor = nil,
...
}), new objj_method(sel_getUid("toolbarLabelShadowColor"), function $_CPHUDWindowView__toolbarLabelShadowColor(self, _cmd)
{ with(self)
{
