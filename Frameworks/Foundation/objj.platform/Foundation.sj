...
p;12;CPIndexSet.ji;9;CPRange.ji;10;CPObject.jc;11806;
...
p;19;CPJSONPConnection.jI;21;Foundation/CPObject.jc;3285;
...
i;13;CPArray+KVO.jp;21;CPKeyValueObserving.ji;9;CPArray.ji;14;CPDictionary.ji;13;CPException.ji;10;CPObject.ji;7;CPSet.jc;14889;
var _1=objj_getClass("CPObject");
if(!_1){
objj_exception_throw(new objj_exception(OBJJClassNotFoundException,"*** Could not find definition for class \"CPObject\""));
}
...
objj_msgSend(objj_msgSend(_1d,"objectForKey:",objj_msgSend(_19,"UID")),"_removeObserver:forKeyPath:",_1b,_1c);
}
})]);
...
var _45=objj_msgSend(_26,"objectForKey:",objj_msgSend(_nativeClass,"UID"));
if(!_45){
_45=objj_msgSend(CPDictionary,"new");
objj_msgSend(_26,"setObject:forKey:",_45,objj_msgSend(_nativeClass,"UID"));
}
...
objj_msgSend(_4f,"setObject:forKey:",_50(_4a,_4c,_4d,_4e),objj_msgSend(_4a,"UID"));
...
var _58=objj_msgSend(_57,"objectForKey:",objj_msgSend(_55,"UID")).forwarder;
objj_msgSend(_58,"finalize");
}
objj_msgSend(_57,"removeObjectForKey:",objj_msgSend(_55,"UID"));
...
objj_msgSend(_1d,"removeObjectForKey:",objj_msgSend(_targetObject,"UID"));
}
}
...
var _67=objj_msgSend(objj_msgSend(objj_msgSend(_26,"objectForKey:",objj_msgSend(_nativeClass,"UID")),"objectForKey:",_5b),"allObjects");
if(!_67){
return;
}
...
with(_69){
var _6c=objj_msgSend(_1d,"objectForKey:",objj_msgSend(_6b,"UID"));
if(_6c){
return _6c;
}
_6c=objj_msgSend(objj_msgSend(_69,"alloc"),"initWithTarget:",_6b);
objj_msgSend(_6c,"_replaceClass");
objj_msgSend(_1d,"setObject:forKey:",_6c,objj_msgSend(_6b,"UID"));
return _6c;
}
})]);
...
with(_7f){
return objj_msgSend(_1d,"objectForKey:",objj_msgSend(_7f,"UID"))._nativeClass;
}
...
p;22;CPNotificationCenter.ji;9;CPArray.ji;14;CPDictionary.ji;16;CPNotification.ji;13;CPException.jc;6577;
var _1=nil;
...
if(_3e!=nil&&(_postingObservers=objj_msgSend(_objectObservers,"objectForKey:",objj_msgSend(_3e,"UID")))){
...
p;7;CPSet.ji;10;CPObject.ji;9;CPArray.ji;10;CPNumber.ji;14;CPEnumerator.jc;7779;
...
p;10;CPString.ji;10;CPObject.ji;13;CPException.ji;18;CPSortDescriptor.ji;9;CPValue.jc;9348;
